    ...
    return (
      <BottomSheet ref={ref} snapPoints={['60%', '80%']}>
        <View className="flex-1 px-4 py-2">
          <View className="flex-row justify-between items-center mb-4">
            ...
            <TouchableOpacity onPress={onClear}>
              <Text 
                ...
                style={{ color: tokens.colors.semantic.info, fontSize: tokens.typography.size.sm }}
              >
                Clear all
              </Text>
            </TouchableOpacity>
          ...
          <View className="pt-4 pb-8 border-t border-gray-200 dark:border-slate-800">
            <TouchableOpacity 
              onPress={onApply}
              className="w-full items-center justify-center py-3 rounded-lg"
              style={{ backgroundColor: activeColors.brand }}
            >
              <Text style={{ color: '#ffffff', fontSize: tokens.typography.size.base, fontWeight: '600' }}>
                Apply Filters
              </Text>
            </TouchableOpacity>
          </View>
