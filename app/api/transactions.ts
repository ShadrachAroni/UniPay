...
const MOCK_TRANSACTIONS: Transaction[] = [
  {
    ...
    transaction_time: new Date(Date.now() - 86400000 * 2).toISOString(),
...
export async function getReconciliationMatches(
  id: string,
        ...
        resolve([
          {
            ...
            ai_explanation:
              'Amount matches expected payment from same phone number.',
