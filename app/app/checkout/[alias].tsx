...
import { VerifiedCheckmark } from '../../components/ui/VerifiedCheckmark';
...
export default function GuestCheckoutAmountScreen() {
  ...
  const recipientDisplayName =
    recipient.account_type === 'business'
      ...
      >
        ...
        >
          ...
          <View className="flex-row items-center border-b pb-2 border-gray-200 dark:border-slate-800">
            <Text className="font-bold text-2xl mr-2" style={{ color: tokens.colors.light.brand }}>
              KES
            </Text>
            <TextInput
